...
public class ImportEvent {
  ...
  private static final Logger log = LogManager.getLogger(ImportEvent.class.getName());
  ...
  public static List<ImportEvent> fromGeneric(List<Map<String, String>> data) {
    return data.stream().map(ImportEvent::fromGeneric).collect(Collectors.toList());
  }

  public static ImportEvent fromGeneric(Map<String, String> data) {
  ...
  public static List<ImportEvent> fromFBFundraiser(List<Map<String, String>> data) {
    return data.stream().map(ImportEvent::fromFBFundraiser).collect(Collectors.toList());
  }

  // Taken from a sample CSV export from STS's Jan-Feb 2021 FB fundraisers.
  public static ImportEvent fromFBFundraiser(Map<String, String> data) {
    ImportEvent importEvent = new ImportEvent();
