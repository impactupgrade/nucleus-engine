...
public class ScheduledTasksJob implements Job {
    ...
    public void execute(JobExecutionContext jobExecutionContext) {
        ...
        log.info("Prev execution time: {}", jobExecutionContext.getTrigger().getPreviousFireTime());
        log.info("Next execution time: {}", jobExecutionContext.getTrigger().getNextFireTime());
